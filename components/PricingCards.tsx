...
const plans: Plan[] = [
  {
    id: 'starter',
    name: 'Starter',
    tagline: 'Per attività che iniziano con le prenotazioni online — ristoranti, saloni, studi professionali.',
    ...
    features: [
      ...
      'Widget prenotazioni per il tuo sito',
  ...
  },
  {
    ...
    features: [
      ...
      'Aggiornamento menu da WhatsApp',
      'Upsell AI nel carrello ordini',
      'Stampa menu in PDF/PNG',
      'Promozioni a sconto sui giorni deboli',
      'Promemoria automatici avanzati',
      'Tracking completo dei canali',
      'Link tracciati per Instagram, Google, WhatsApp, QR e sito',
      'Comparsa prioritaria su prenota.locario.net',
  ...
  },
  {
    id: 'business',
    name: 'Business',
    tagline: 'Per strutture ad alto volume, team grandi, più sedi o più attività sullo stesso account, e configurazioni personalizzate.',
